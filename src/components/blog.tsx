  ...
  return (
    <article>
      <a href="https://blog.samrid.me">
        <div class="flex max-w-xl flex-col items-start transition-all hover:shadow-md rounded-lg justify-between border-slate-200 border p-3">
          ...
          <div class="group relative flex flex-col">
            ...
            <ul class="text-sm mt-3 leading-4 flex flex-row text-slate-800">
              <li class="mr-2 border p-1 rounded-lg">#python3</li>
              <li class="mr-2 border p-1 rounded-lg">#GIL</li>
            </ul>

            <ArrowLink href="https://blog.samrid.me" label="Read" />
          </div>
        </div>
      </a>
    </article>
